...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    {
      name: 'add_comment',
      description: 'Add a comment to a ticket. Posts a plain-text/markdown message as an activity on the entry — shows up in the ticket\'s comment thread, visible to the whole team.',
      inputSchema: {
        type: 'object',
        properties: {
          listId: { type: 'string', description: 'Collection (list) ID' },
        ...
        required: ['listId', 'entryId', 'message'],
      },
    },
    {
      name: 'delete_comment',
    ...
    {
      name: 'update_comment',
      description: 'Edit the text of an existing comment. Requires listId and the comment\'s id (returned by add_comment as "id", not entryId).',
      inputSchema: {
        type: 'object',
        properties: {
          listId: { type: 'string', description: 'Collection (list) ID' },
        ...
        required: ['listId', 'commentId', 'message'],
      },
    },
    {
